<?php
//Template Name: Debugging- Admin


require_once( 'library/classes/campaignmonitor/csrest_transactional_smartemail.php' );

//TouchPoint::getEmails();

        global $wpdb;

	// NTMxMzNmMjc0ZmEzMmRhMTE4YmUxNDU0MmRlZTdlNTM5MGJiMjFjZjc1OTkyMTZjOg==

	// 53133f274fa32da118be14542dee7e5390bb21cf7599216c
