...
<?php // You can start editing here. ?>
  ...
  <?php if ( have_comments() ) : ?>
    ...
    <h3 class="h2" style="margin: 0;"><?php comments_number( __( '<span>No</span> Comments', 'bonestheme' ), __( '<span>One</span> Comment', 'bonestheme' ), _n( '<span>%</span> Comments', '<span>%</span> Comments', get_comments_number(), 'bonestheme' ) );?></h3>
