...
$photos = array(53284, 53197, 53159, 53142, 53091, 53055, 52836);

?>
<style>
	#post-items-with-bt a{
		min-height:120px;
	}
</style>
<div id="hammer-open">
        ...
        <div class="drawer-container">
            ...
            <?php
                ...
                foreach ($cats as $category):
                    $img = wp_get_attachment_image_src( $photos[$counter_img++], 'thumbnail')[0];
            ?>
...
//                        );
            ?>
                    ...
                    <img src="<?= $img; ?>" alt="img" style="width: 15px; height: 15px; margin-right: 10px;">
