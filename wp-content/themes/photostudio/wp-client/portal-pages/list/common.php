                    ...
                    <div class="wpc_sort_contect">
                        <label>
                            ...
                            <select class="wpc_sorting wpc_selectbox">
                                ...
                                <option value="title_asc" <?php selected( $sort == 'title' && $dir == 'asc' ); ?> >
                                    <?php echo __( 'Title', WPC_CLIENT_TEXT_DOMAIN ) . ' ' . __( 'Asc', WPC_CLIENT_TEXT_DOMAIN ); ?>
                                </option>

                                <option value="title_desc" <?php selected( $sort == 'title' && $dir == 'desc' ); ?> >
                                    <?php echo __( 'Title', WPC_CLIENT_TEXT_DOMAIN ) . ' ' . __( 'Desc', WPC_CLIENT_TEXT_DOMAIN ); ?>
                                </option>

                                <option value="date_asc" <?php selected( $sort == 'date' && $dir == 'asc' ); ?> >
                                    <?php echo __( 'Added', WPC_CLIENT_TEXT_DOMAIN ) . ' ' . __( 'Asc', WPC_CLIENT_TEXT_DOMAIN ); ?>
                                </option>

                                <option value="date_desc" <?php selected( $sort == 'date' && $dir == 'desc' ); ?> >
                                    <?php echo __( 'Added', WPC_CLIENT_TEXT_DOMAIN ) . ' ' . __( 'Desc', WPC_CLIENT_TEXT_DOMAIN ); ?>
                                </option>

                                <option value="category_asc" <?php selected( $sort == 'category_name' && $dir == 'asc' ); ?> >
                                    <?php echo __( 'Category', WPC_CLIENT_TEXT_DOMAIN ) . ' ' . __( 'Asc', WPC_CLIENT_TEXT_DOMAIN ); ?>
                                </option>

                                <option value="category_desc" <?php selected( $sort == 'category_name' && $dir == 'desc' ); ?> >
