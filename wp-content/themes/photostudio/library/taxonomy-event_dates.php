...
if (empty($photos) || $photos[0] == '') {
    ...
    foreach ($photos as $g) {
        ...
        ?>
                    eventElements.push({
                        ...
                        'reference': '<?php echo $g->post_title; ?>',
    ...
    foreach ($photos as $g) {
        ...
        echo <<<EOT
                            <div class="event-item-listing" data-reference="{$g->post_title}" data-image="{$bgFull[0]}" data-votes="{$votes}" data-pid="{$g->ID}">
