        ...
        <div class="container">
            ...
            <form name="touchpoint-form" id="touchpoint-form" action="?page=tps-touch-point&tab=booking-view&id=<?php echo $_GET['id']; ?>&action=update-booking" class="list-of-touchpoints" method="POST" onsubmit="return validateBooking()" method="POST">
                ...
                <ul class="customer-details">
                    <li><label>First Name</label><div><input type="text" name="booking-first-name" value="<?php echo $booking->first_name; ?>"></div></li>
                    <li><label>Last Name</label><div><input type="text" name="booking-last-name" value="<?php echo $booking->last_name; ?>"></div></li>
...
?>"></div></li>
                ...
                <ul class="touchpoint-message">
                    ...
                    <textarea name="message"><?php echo $booking->message; ?></textarea>
                </ul>
