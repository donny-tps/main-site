...
function custom_post_staff() {
    ...
    register_post_type('staff_type', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
            // let's now add all the options for this post type
            array('labels' => array(
            'name' => __('The Team', 'bonestheme'), /* This is the Title of the Group */
            ...
            'add_new' => __('Add New Staff', 'bonestheme'), /* The add new menu item */
        ...
        'description' => __('This is the staff edit screen', 'bonestheme'), /* Custom Type Description */
        'public' => false,
        ...
        'has_archive' => 'staff_type', /* you can rename the slug here */
...
register_taxonomy('staff_cat', array('staff_type'), /* if you change the name of register_post_type( 'staff_type', then you have to change this */ array('hierarchical' => true, /* if this is true, it acts like categories */
    'labels' => array(
        ...
        'new_item_name' => __('New Custom Staff Name', 'bonestheme') /* name title for taxonomy */
    ),
