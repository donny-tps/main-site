jQuery(function($){
    ...
    jQuery('.magazine-filter').on('click', '.magazine-filter-item > span', function (e) {
        ...
        //if( $this.parent('.has-child-item').length ) return; // not filtering if have child categories
        ...
        appendToFilter();
        setTimeout(function () {
            isotopeWrap.isotope({filter: filterItems.join(', ')}).isotope();
        }, 1000);
    });
        ...
        window.setTimeout(function(){
            ...
            if( $submenu.length ) {
                ...
                window.setTimeout(function(){
                    ...
                    // $submenu.css('top', buttonPos.top + 43 + 'px').css('height', submenuHeight-10);
    ...
    function loadMorePostsHandler() {
        ...
        jQuery.ajax({
            ...
            success:function(data){
                ...
                console.log(filterNewItemsPages);
            }
        });
    }
});
   ...
   $(window).load(function(){
       ...
       $('#post-items-with-bt').on('mouseout', '.post-item_cart-back-content', function(e){
           $(this)
               ...
               .css( 'height', $this.attr('data-height-container') );
       });
       /*
