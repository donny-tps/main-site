    ...
    <div class="the-team-wrapper">
        <div class="site-width">            
            ...
            <div class="team-filters">
                ...
                $terms = get_terms('staff_cat', $args);
                foreach ($terms as $t) {
                    echo '<span class="filter-item" data-slug="' . $t->slug . '">' . $t->name . '</span>';
                }
                ?>
            </div> 
            <div class="team-members">
                ...
                foreach ($staff as $s) {
                    ...
                    $bg = wp_get_attachment_url(get_post_thumbnail_id($s->ID));

                    $_postTerms = wp_get_post_terms($s->ID, 'staff_cat');
                    ...
                    $position = get_field('position', $s->ID);
                    echo <<<EOT
                    
                    <div class="staff-item {$terms}" style="background-image:url('{$bg}');">
                        <div class="plus">+</div>
                        <div class="staff-details">
                            <span class="staff-title">{$s->post_title}</span>
                            <span class="position">{$position}</span>
                            {$s->post_content}
                        </div>                        
                            <span class="staff-name">$s->post_title</span>
                    </div>
