jQuery(document).ready(function() {
    ...
    jQuery( '.wpc_client_client_pages_tree' ).on( 'click', '.indenter', function(e) {
    ...
    jQuery( '.wpc_client_client_pages_tree' ).on( 'click', '.wpc_treetable_portal_pages_category', function() {
        var obj = jQuery(this);
