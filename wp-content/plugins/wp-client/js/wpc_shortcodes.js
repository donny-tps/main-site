    ...
    jQuery(document).on('click', '.add_shortcode_button', function() {
        ...
        if ( $('#wp-content-wrap').hasClass('tmce-active') ) {
            if ( typeof CKEDITOR != 'undefined' ) {
                ...
                CKEDITOR.instances.content.insertText( wpc_shortcode );
            } else {
            ...
            insertAtCursor( document.getElementById( 'content' ), wpc_shortcode );
        }

        jQuery('#wpc_add_shortcode').shutter_box('close');
    });
