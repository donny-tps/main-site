<?php
 if ( ! defined( 'ABSPATH' ) ) { exit; } global $wp_roles; if ( isset( $_POST['save_rules'] ) ) { if ( isset( $_POST['wpc_auto_convert_rules'] ) && is_array( $_POST['wpc_auto_convert_rules'] ) ) { do_action( 'wp_client_settings_update', $_POST['wpc_auto_convert_rules'], 'auto_convert_rules' ); } else { do_action( 'wp_client_settings_update', array(), 'auto_convert_rules' ); } $this->redirect( $this->settings()->get_current_setting_url() . '&msg=u' ); } $wpc_auto_convert_rules = $this->cc_get_settings( 'auto_convert_rules' ); $all_roles = $wp_roles->roles; $section_fields = array( array( 'type' => 'title', 'label' => __( 'Auto-Convert Rules', WPC_CLIENT_TEXT_DOMAIN ), ), ); $this->settings()->render_settings_section( $section_fields ); ?>
...
<div class="wpc_tab_container_block wpc_auto_convert_rules">
 ...
 switch( $rule['to_role'] ) { case 'wpc_client': { ?>
                            ...
                            <tr>
                                <td>
                                    <label for="wpc_<?php echo $key ?>_create_client_page"><?php printf( __( 'Create %s Automatically', WPC_CLIENT_TEXT_DOMAIN ) , $this->custom_titles['portal_page']['s'] ) ?></label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <br>
                                    <span class="description"><?php printf( __( "If set to Yes, the user's current role will be saved, and %s role will be added.", WPC_CLIENT_TEXT_DOMAIN ), $this->plugin['title'] ) ?></span>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
