<?php
 if ( ! defined( 'ABSPATH' ) ) { exit; } $wpc_currency = $this->cc_get_settings( 'currency' ); $section_fields = array( array( 'type' => 'title', 'label' => __( 'Currency Settings', WPC_CLIENT_TEXT_DOMAIN ), ), ); $this->settings()->render_settings_section( $section_fields ); ?>
