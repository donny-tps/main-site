...
<div class="wrap">
    ...
    <div id="wpc_container">
        ...
        <div class="wpc_tab_container_block">
            <?php switch ( $current_tab ) { case "portal_page": include_once( $this->plugin_dir . 'includes/admin/templates_portal_page.php' ); break; case "emails": include_once( $this->plugin_dir . 'includes/admin/templates_emails.php' ); break; case "php_templates": include_once( $this->plugin_dir . 'includes/admin/templates_php.php' ); break; default: do_action( 'wpc_client_templates_tabs_' . $current_tab ); break; } ?>
        </div>
    </div>
</div>