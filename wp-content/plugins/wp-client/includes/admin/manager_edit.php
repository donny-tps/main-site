...
<div class="wrap">
 ...
 do_action( 'wpc_client_manager_add_edit_form_html', $manager_data ); ?>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="wpclients_managers"><?php printf( '%s %s', $this->custom_titles['manager']['s'], $this->custom_titles['client']['p'] ) ?></label>
                                </th>
                                <td>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="wpclients_managers"><?php printf( '%s %s %s', $this->custom_titles['manager']['s'], $this->custom_titles['client']['s'], $this->custom_titles['circle']['p'] ) ?>: </label>
                                </th>
                                <td>
