            ...
            <div class="wpc_form_line">
                ...
                <div class="wpc_form_field">
                    <label class="terms_label" data-title="<?php _e( 'Terms/Conditions', WPC_CLIENT_TEXT_DOMAIN ); ?>" for="wpc_terms_agree">
                        <input type="checkbox" id="wpc_terms_agree" name="terms_agree" value="1" data-required_field="1" <?php echo $vals['terms_default_checked']; ?> />
                        &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $terms_agree; ?>
                    </label>
                    <a href="<?php echo $vals['terms_hyperlink']; ?>" target="_blank" title="<?php _e( 'Terms/Conditions', WPC_CLIENT_TEXT_DOMAIN ); ?>"><?php _e( 'Terms/Conditions', WPC_CLIENT_TEXT_DOMAIN ); ?></a>
