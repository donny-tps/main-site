<?php
/**
 * Template Name: Client Registration Successfull
 * Template Description: This template for [wpc_client_registration_successful] shortcode
 * Template Tags: Registration, Forms
 *
 * This template can be overridden by copying it to your_current_theme/wp-client/form/registration/successfull.php.
 *
...
__( 'Client Registration Successfull', WPC_CLIENT_TEXT_DOMAIN );
